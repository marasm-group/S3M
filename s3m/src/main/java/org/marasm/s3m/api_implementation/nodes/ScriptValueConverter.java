...
public final class ScriptValueConverter {
    ...
    public static Object unwrapValue(Object value) {
        if (value == null) {
            ...
            // check for special case of a Date object
                ...
                if (values instanceof NativeArray && isArray(propIds)) {
                    ...
                    final List<Object> propValues = new ArrayList<>(propIds.length);
                    ...
                    for (Object propId1 : propIds) {
                        ...
                        final Integer propId = (Integer) propId1;
                    ...
                    final Map<String, Object> propValues = new HashMap<>(propIds.length);
        ...
        } else if (value instanceof ScriptableMap) {
            return ((ScriptableMap) value).getMap();
        }
        return value;
    }
    ...
    public static Object wrapValue(Scriptable scope, Object value) {
        ...
        if (value == null) {
            ...
            value = new ScriptableMap((Map) value);
        }
